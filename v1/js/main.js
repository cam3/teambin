    ...
    $stateProvider
       ...
       .state('modules', {
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before a LINK element with this ID. Dynamic CSS files must be loaded between core and theme css files
                        files: [
                            'js/controllers/ModuleController.js'
                        ] 
                    });
                }]
            }
        ...
        .state('modules.detail', {
            ...
            controller: function($scope, $stateParams){
                ...
                $scope.module = getByValue($scope.training, $stateParams.uid);
       ...
       // Training Page
        .state('training', {
            ...
            data: {pageTitle: 'Training Module Page'},
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before a LINK element with this ID. Dynamic CSS files must be loaded between core and theme css files
                        files: [
                            'js/controllers/TrainingController.js'
                        ] 
                    });
                }]
            }
        ...
        .state('module', {
                ...
                data: {pageTitle: 'Training Module'},
                controller: "ModuleController",
                resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
